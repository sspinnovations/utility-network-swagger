...
class DefaultApi(object):
    ...
    def server_web_adaptor_rest_services_utility_network_name_utility_network_server_update_is_connected_post(self, body, f, token, server_web_adaptor, utility_network_name, **kwargs):  # noqa: E501
        """updateIsConnected  # noqa: E501

        UtilityNetworkService  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_web_adaptor_rest_services_utility_network_name_utility_network_server_update_is_connected_post(body, f, token, server_web_adaptor, utility_network_name, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.server_web_adaptor_rest_services_utility_network_name_utility_network_server_update_is_connected_post_with_http_info(body, f, token, server_web_adaptor, utility_network_name, **kwargs)  # noqa: E501
        else:
            (data) = self.server_web_adaptor_rest_services_utility_network_name_utility_network_server_update_is_connected_post_with_http_info(body, f, token, server_web_adaptor, utility_network_name, **kwargs)  # noqa: E501
            return data

    def server_web_adaptor_rest_services_utility_network_name_utility_network_server_update_is_connected_post_with_http_info(self, body, f, token, server_web_adaptor, utility_network_name, **kwargs):  # noqa: E501
        """updateIsConnected  # noqa: E501

        UtilityNetworkService  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_web_adaptor_rest_services_utility_network_name_utility_network_server_update_is_connected_post_with_http_info(body, f, token, server_web_adaptor, utility_network_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'f', 'token', 'server_web_adaptor', 'utility_network_name']  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `server_web_adaptor_rest_services_utility_network_name_utility_network_server_update_is_connected_post`")  # noqa: E501
