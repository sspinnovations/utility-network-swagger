...
namespace IO.Swagger.Model
{
        ...
        public partial class TokenRequest :  IEquatable<TokenRequest>, IValidatableObject
    {
        ...
        public TokenRequest(string username = default(string), string password = default(string), string ip = default(string), string referer = default(string), decimal? expiration = default(decimal?), string f = "json")
        {
            ...
            if (expiration == null)
            {
                throw new InvalidDataException("expiration is a required property for TokenRequest and cannot be null");
            }
            else
            {
            ...
            if (f == null)
            {
                throw new InvalidDataException("f is a required property for TokenRequest and cannot be null");
            }
            else
            {
                this.F = f;
