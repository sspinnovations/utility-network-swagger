...
case class TraceResultsSetTraceResults (
  elements: Option[Seq[TraceResultsSetTraceResultsElements]],
  diagramName: Option[String],
  globalFunctionResults: Option[Seq[String]],
  kFeaturesForKNNFound: Option[Boolean],
  startingPointsIgnored: Option[Boolean],
