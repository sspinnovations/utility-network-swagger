...
case class FunctionBarrier (
  /* Choose from a number of different calculation functions. */
  functionType: FunctionBarrierEnums.FunctionType,
  ...
  operator: FunctionBarrierEnums.Operator,
  ...
  useLocalValues: Option[Boolean]
) extends ApiModel

object FunctionBarrierEnums {
