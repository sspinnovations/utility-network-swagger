...
export namespace TraceLocation {
    export type TraceLocationTypeEnum = 'startingPoint' | 'stoppingPoint';
    export const TraceLocationTypeEnum = {
        StartingPoint: 'startingPoint' as TraceLocationTypeEnum,
        StoppingPoint: 'stoppingPoint' as TraceLocationTypeEnum
    };
}